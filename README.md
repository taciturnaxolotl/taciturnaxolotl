...
- [`battleship-arena`](https://github.com/taciturnaxolotl/battleship-arena) - _a geicko-2 based round robin ranking system designed to test c++ battleship submissions_ **(1 day ago)**
- [`ncae-tools`](https://github.com/taciturnaxolotl/ncae-tools) - _writeups for ncae cybergames 2025_ **(2 days ago)**
- [`paper-crown`](https://github.com/taciturnaxolotl/paper-crown) - _minecraft exploit testbed_ **(3 days ago)**
- [`thyme-module`](https://github.com/taciturnaxolotl/thyme-module) - _the zmk module for thyme_ **(6 days ago)**
- [`thistle`](https://github.com/taciturnaxolotl/thistle) - _🪻 distributed transcription service_ **(6 days ago)**
...
- [`Novel phishing tactic using github notifications`](https://dunkirk.sh/blog/github-phishing/) **(1 month ago)**
