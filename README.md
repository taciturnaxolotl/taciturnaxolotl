...
- [`ncae-tools`](https://github.com/taciturnaxolotl/ncae-tools) - _writeups for ncae cybergames 2025_ **(5 days ago)**
- [`paper-crown`](https://github.com/taciturnaxolotl/paper-crown) - _minecraft exploit testbed_ **(6 days ago)**
